    ...
    <div class="center-main-container home-page">
      <div class="center-container">
        <div class="latest-event d-xl-flex">
          <div v-for="(event, index) in latestEvents" :key="index" class="latest-event-item">
        ...
        <ul class="nav nav-pills sports-tab">
          <li v-for="(item, index) in sportsTabs" :key="index" class="nav-item">
            <a :class="['nav-link', item.active ? 'active' : '']" :href="item.link" @click="setActiveTab(item.name)">
              <div class="d-xl-none">
        ...
        <div class="casino-list mt-2">
          <div v-for="(casino, index) in casinoItems" :key="index" class="casino-list-item">
            <a :href="casino.link">
