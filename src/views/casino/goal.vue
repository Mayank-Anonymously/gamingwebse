                  ...
                  >
                            ...
                            <div class="market-row">
                              ...
                              <div class="fancy-min-max-box">
                                <div class="fancy-min-max">
                                  ...
                                  ><span class="w-100 d-block">Max: 50K</span>
                                </div>
                              </div>
                            </div>
                          </div>
                    ...
                    <div class="casino-remark mt-1">
                      <div class="remark-icon">
                        <img
                          src="https://versionobj.ecoassetsservice.com/v29/static/front/img/icons/remark.png"
                        />
                      </div>
                      <marquee scrollamount="3"
                        >Results are based on stream&nbsp;only</marquee
                      >
                    </div>
